...
import com.wso2.jetbrains.siddhi.adaptor.psi.Trees;
 ...
 */
public class SiddhiExternalAnnotator extends ExternalAnnotator<PsiFile, List<SiddhiExternalAnnotator.Issue>> {
	...
	public List<Issue> doAnnotate(final PsiFile file) {
		Collection<? extends PsiElement> funcNameNodes =
			XPath.findAll(SiddhiLanguage.INSTANCE, file, "/script/function/ID");
		Collection<? extends PsiElement> funcCallNameNodes =
			XPath.findAll(SiddhiLanguage.INSTANCE, file, "//call_expr/ID");
