...
public abstract class SiddhiElementRef extends PsiReferenceBase<IdentifierPSINode> {
	public SiddhiElementRef(@NotNull IdentifierPSINode element) {
		/** WARNING: You must send up the text range or you get this error:
		 * "Cannot find manipulator for PsiElement(ID) in org.antlr.jetbrains.sample.SiddhiElementRef"...
